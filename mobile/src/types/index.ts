...
// ── AI listing assistant (plan 4.1) ─────────────────────────────────────────
// The mobile client never talks to the model — these mirror the request/
// already-validated response shapes of the shared Cloud Function callables.
