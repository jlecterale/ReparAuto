...
import type { TipoDocumento, TipoVerificacao } from '@/types';

// Human labels for every accepted document, shared by the request screen and
// the admin review queue so a new market's documents render correctly in both.
// Kept in sync with the web `src/lib/verificationDocs.ts` (tested there).
