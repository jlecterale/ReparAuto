  ...
  return (
    <div className="page-enter max-w-3xl mx-auto">
      <div className="text-center mb-6">
        <h1 className="text-2xl sm:text-3xl font-extrabold text-brand-900 flex items-center justify-center gap-2">
          <i className="fa-solid fa-calculator text-accent"></i>
          Avaliar veículo
        </h1>
      ...
      <div className="mt-6 bg-brand-50 border border-brand-100 rounded-xl p-5 text-sm text-slate-700">
        <h2 className="font-bold text-brand-900 mb-2 flex items-center gap-2">
