    ...
    <>
      ...
      >
        ...
        <div className="border-t border-white/5 p-3">
          ...
          {/* Market switcher — shown for anonymous visitors (free choice) and
              admin users (testing both markets). Regular signed-in users have
              their market bound to their account, so it stays hidden for them.
